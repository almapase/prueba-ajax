...
class ClaimsControllerTest < ActionController::TestCase
  ...
  test "should create claim" do
    assert_difference('Claim.count') do
      post :create, claim: { company_id: @claim.company_id, description: @claim.description, user_id: @claim.user_id }
    end
  ...
  test "should update claim" do
    patch :update, id: @claim, claim: { company_id: @claim.company_id, description: @claim.description, user_id: @claim.user_id }
    assert_redirected_to claim_path(assigns(:claim))
  end
